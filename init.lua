...
-- Otherwise, normally need to press <C-\><C-n>.
--
...
--
-- Plugins can be added using a link or for a github repo: 'owner/repo'.
--
...
-- function, forcing the plugin to be loaded. The configuration runs
...
require('lazy').setup({
  { -- Python `uv` integration with Neovim
    ...
    config = function()
      ...
      map('n', '<leader>xtf', function()
        ...
        noremap = true,
        desc = 'UV run pytest (selected file)',
      })
    end,
  },
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    dependencies = {
      ...
      -- Sets vim.ui.select to telescope; neovim core stuff can fill telescope picker.
      { 'nvim-telescope/telescope-ui-select.nvim' },

      -- Get pretty icons; requires a Nerd Font.
      { 'nvim-tree/nvim-web-devicons', enabled = vim.g.have_nerd_font },
    },
    config = function()
      -- Opens a window that shows you all of the keymaps for the current picker.
      --  - Insert mode: <c-/>
      --  - Normal mode: ?

      -- [[ Configure Telescope ]]
      require('telescope').setup {
        -- NOTE: Put default mappings / updates / etc. in here.
        -- Check `:help telescope.setup()` for guidance.
        --
        -- defaults = {
        --   mappings = {},
        -- },
      ...
      -- Enable Telescope extensions (defined above in dependencies)
      pcall(require('telescope').load_extension, 'fzf')
      pcall(require('telescope').load_extension, 'ui-select')

      -- NOTE: Set Telescope keymaps here.
      ...
      -- Create a floating window dropdown for searching the current buffer.
  ...
  },
  {
    ...
    config = function()
      --  This function is run when an LSP attaches to a buffer.
      vim.api.nvim_create_autocmd('LspAttach', {
        group = vim.api.nvim_create_augroup('kickstart-lsp-attach', { clear = true }),
        callback = function(event)
          -- Define mappings specific for LSP related items.
          -- Set the mode, buffer and description.
          local map = function(keys, func, desc, mode)
            mode = mode or 'n'
            vim.keymap.set(mode, keys, func, { buffer = event.buf, desc = 'LSP: ' .. desc })
          end

          -- NOTE: Define LSP key maps here.
          ...
          -- WARN: Do not remove unless you know what you're doing.
      ...
      -- Install LSP servers defined above.
      -- Add other tools here for Mason to install so they are available within Neovim.
      ...
      require('mason-lspconfig').setup {
        ensure_installed = {}, -- explicitly set to an empty table (install defined above using via mason-tool-installer)
